...
import "./style.css";
import ChatHeader from "./chatbotElements/ChatHeader";
import ChatbotContent from "../chatbot/chatbotElements/ChatbotContent";
import { useVisitorId } from "../../hooks/useVisitorId";
import MessagesSession from "./chatbotElements/MessagesSession";
import {
  emailRegex,
  formatTime,
  phoneRegex,
...
import { BottomNavigation } from "./chatbotElements/BottomNavigation/BottomNavigation";
import { ConversationsScreen } from "./chatbotElements/ConversationsScreen/ConversationsScreen";
        ...
        <div className={`window ${isToggled ? "light" : ""}`}>
          {messagesSession || currentSession?.is_form_filled ? (
            <MessagesSession
              ...
              isDisabled={chatArray.length && sessionLoader}
